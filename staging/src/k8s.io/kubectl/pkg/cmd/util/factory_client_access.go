...
func NewFactoryWithOptions(clientGetter genericclioptions.RESTClientGetter, opts FactoryOptions) Factory {
	if clientGetter == nil {
...
func NewFactory(clientGetter genericclioptions.RESTClientGetter) Factory {
	return NewFactoryWithOptions(clientGetter, FactoryOptions{})
}
